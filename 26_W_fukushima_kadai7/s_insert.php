...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO  gs_students_table (s_id, s_name, s_account, s_mail, s_pw, s_life_flg,
...
$stmt->bindValue(':a5', $s_life_flg, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$status = $stmt->execute();
