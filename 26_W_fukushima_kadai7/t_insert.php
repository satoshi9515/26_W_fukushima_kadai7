...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO  gs_teachers_table (t_id, t_name, t_account, t_mail, t_pw, t_life_flg,
...
$stmt->bindValue(':a5', $t_life_flg, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$status = $stmt->execute();
